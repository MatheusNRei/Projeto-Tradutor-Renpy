...
translate spanish start_0e6a5bb4:
    ...
    e "Oi! Meu nome é Eileen e gostaria de dar as boas-vindas ao tutorial do Ren'Py."
...
translate spanish start_d3abb53c:
    ...
    e "Neste tutorial, ensinaremos a você o básico do Ren'Py, para que você possa fazer seus próprios jogos. Também demonstraremos muitos recursos, para que você possa ver do que o Ren'Py é capaz."

# game/script.rpy:205
translate spanish end_b2482727:

    # e "Thank you for viewing this tutorial."
    e "Obrigado por ver este tutorial."

# game/script.rpy:207
translate spanish end_38362e36:

    # e "If you'd like to see a full Ren'Py game, select \"The Question\" in the launcher."
    e "Se você gostaria de ver um jogo Ren'Py completo, selecione \" A pergunta \ "no inicializador."
...
translate spanish end_02527d05:
    ...
    e "Você pode baixar novas versões do Ren'Py em {a = https: //www.renpy.org/} https://www.renpy.org/ {/ a}. Para obter ajuda e discussão, verifique o {a = https: //lemmasoft.renai.us/forums/} Fóruns Lemma Soft {/ a}. "
...
translate spanish end_c9d03136:
    ...
    e "Gostaríamos de agradecer a Piroshki por contribuir com meus sprites; Mugenjohncel por Lucy, a banda e os planos de fundo desenhados; e Jake pelo círculo mágico."
...
translate spanish end_762dc07a:
    ...
    e "A música de fundo é \" Sunflower Slow Drag \ ", de Scott Joplin e Scott Hayden, interpretada pela United States Marine Band. A música do concerto é de Alessio."

# game/script.rpy:217
translate spanish end_a634d396:

    # e "We look forward to seeing what you create with Ren'Py. Have fun!"
    e "Estamos ansiosos para ver o que você cria com Ren'Py. Divirta-se!"
...
translate spanish strings:
    ...
    new "Experiência do Jogador"

    # script.rpy:59
    old "Creating a New Game"
    new "Criando um Novo Jogo"

    # script.rpy:60
    old "Writing Dialogue"
    new "Escrevendo Diálogo"

    # script.rpy:61
    old "Adding Images"
    new "Adicionando Imagens"

    # script.rpy:62
    old "Positioning Images"
    new "Posicionando Imagens"
    ...
    new "Música e efeitos sonoros"

    # script.rpy:65
    old "Choices and Python"
    new "Choices and Python"

    # script.rpy:66
    old "Input and Interpolation"
    new "Entrada e Interpolação"

    # script.rpy:67
    old "Video Playback"
    new "Reprodução de vídeo"
    ...
    new "Ferramentas e o diretor interativo"

    # script.rpy:70
    old "Building Distributions"
    new "Construindo Distribuições"
    ...
    new "Tags de texto, escapes e interpolação"

    # script.rpy:75
    old "Character Objects"
    new "Objetos de Personagem"
    ...
    new "Galeria de transição"

    # script.rpy:80
    old "Position Properties"
    new "Propriedades da posição"

    # script.rpy:83
    old "Transforms and Animation"
    new "Transformações e Animação"

    # script.rpy:84
    old "Transform Properties"
    new "Propriedades de transformação"

    # script.rpy:86
    old "GUI Customization"
    new "Personalização de GUI"

    # script.rpy:87
    old "Styles and Style Properties"
    new "Estilos e propriedades de estilo"
    ...
    new "Exibíveis na tela"

    # script.rpy:91
    old "Minigames and CDDs"
    new "Minijogos e CDDs"
    ...
    new "Isso é o suficiente por agora."

    # script.rpy:168
    old "What would you like to see?"
    new "O que você gostaria de ver?"

    # script.rpy:170
    old "Is there anything else you'd like to see?"
    new "Há mais alguma coisa que você gostaria de ver?"
