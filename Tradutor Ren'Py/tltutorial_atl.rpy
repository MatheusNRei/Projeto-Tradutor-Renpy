...
translate spanish tutorial_positions_a09a3fd1:
    ...
    e "Neste tutorial, vou ensinar como Ren'Py posiciona as coisas na tela. Mas antes disso, vamos aprender um pouco sobre como o Python lida com números."
...
translate spanish tutorial_positions_ba39aabc:
    ...
    e "Existem dois tipos principais de números em Python: inteiros e números de ponto flutuante. Um número inteiro consiste inteiramente de dígitos, enquanto um número de ponto flutuante tem um ponto decimal."
...
translate spanish tutorial_positions_a60b775d:
    ...
    e "Por exemplo, 100 é um número inteiro, enquanto 0,5 é um número de ponto flutuante ou, para abreviar, float. Neste sistema, existem dois zeros: 0 é um número inteiro e 0,0 é um float."
...
translate spanish tutorial_positions_7f1a560c:
    ...
    e "Ren'Py usa números inteiros para representar coordenadas absolutas e flutua para representar frações de uma área com tamanho conhecido."
...
translate spanish tutorial_positions_8e7d3e52:
    ...
    e "Quando estamos posicionando algo, a área geralmente é a tela inteira."
...
translate spanish tutorial_positions_fdcf9d8b:
    ...
    e "Deixe-me sair do caminho e mostrarei onde estão algumas posições."
...
translate spanish tutorial_positions_76d7a5bf:
    ...
    e "A origem é o canto superior esquerdo da tela. É onde a posição x (xpos) e a posição y (ypos) são zero."
...
translate spanish tutorial_positions_be14c7c3:
    ...
    e "Quando aumentamos xpos, nos movemos para a direita. Aqui está um xpos de 0,5, o que significa metade da largura da tela."
...
translate spanish tutorial_positions_9b91be6c:
    ...
    e "Aumentar xpos para 1.0 nos move para a borda direita da tela."
...
translate spanish tutorial_positions_2b293304:
    ...
    e "Também podemos usar um xpos absoluto, que é dado em um número absoluto de pixels do lado esquerdo da tela. Por exemplo, como esta janela tem 1280 pixels de largura, usar um xpos de 640 retornará o alvo ao centro de a linha superior. "
...
translate spanish tutorial_positions_c4d18c0a:
    ...
    e "A posição do eixo y, ou ypos, funciona da mesma maneira. No momento, temos ypos de 0,0."

# game/tutorial_atl.rpy:254
translate spanish tutorial_positions_16933a61:

    # e "Here's a ypos of 0.5."
    e "Aqui está um ypos de 0,5."
...
translate spanish tutorial_positions_6eb36777:
    ...
    e "Um ypos de 1.0 especifica uma posição na parte inferior da tela. Se você olhar com atenção, poderá ver o indicador de posição girando abaixo da janela de texto."
...
translate spanish tutorial_positions_a423050f:
    ...
    e "Como xpos, ypos também pode ser um número inteiro. Nesse caso, ypos daria o número total de pixels da parte superior da tela."
...
translate spanish tutorial_positions_bc7a809a:
    ...
    e "Você consegue adivinhar onde está essa posição, em relação à tela?" não interagir
...
translate spanish tutorial_positions_6f926e18:
    ...
    e "Desculpe, está errado. O xpos é .75, e o ypos é .25."
...
translate spanish tutorial_positions_5d5feb98:
    ...
    e "Em outras palavras, é 75 %% do caminho do lado esquerdo e 25 %% do caminho do topo."

# game/tutorial_atl.rpy:279
translate spanish tutorial_positions_77b45218:

    # e "Good job! You got that position right."
    e "Bom trabalho! Você acertou nessa posição."
...
translate spanish tutorial_positions_e4380a83:
    ...
    e "A segunda posição com a qual nos importamos é a âncora. A âncora é um ponto na coisa que está sendo posicionada."
...
translate spanish tutorial_positions_d1db1246:
    ...
    e "Por exemplo, aqui temos uma xâncora de 0,0 e uma yâncora de 0,0. Está no canto superior esquerdo da imagem do logotipo."
...
translate spanish tutorial_positions_6056873f:
    ...
    e "Quando aumentamos o xanchor para 1.0, a âncora se move para o canto direito da imagem."
...
translate spanish tutorial_positions_7cdb8dcc:
    ...
    e "Da mesma forma, quando xanchor e yanchor são 1.0, a âncora é o canto inferior direito."
...
translate spanish tutorial_positions_03a07da8:
    ...
    e "Para colocar uma imagem na tela, precisamos tanto da posição quanto da âncora."
...
translate spanish tutorial_positions_8945054f:
    ...
    e "Em seguida, os alinhamos, de modo que a posição e a âncora fiquem no mesmo ponto da tela."
...
translate spanish tutorial_positions_2b184a93:
    ...
    e "Quando colocamos ambos no canto superior esquerdo, a imagem se move para o canto superior esquerdo da tela."
...
translate spanish tutorial_positions_5aac4f3f:
    ...
    e "Com a combinação certa de posição e âncora, qualquer lugar da tela pode ser especificado, mesmo sem saber o tamanho da imagem."
...
translate spanish tutorial_positions_3b59b797:
    ...
    e "Muitas vezes é útil definir xpos e xanchor com o mesmo valor. Chamamos isso de xalign e ele fornece uma posição fracionária na tela."
...
translate spanish tutorial_positions_b8ebf9fe:
    ...
    e "Por exemplo, quando definimos xalign para 0,0, as coisas são alinhadas do lado esquerdo da tela."
...
translate spanish tutorial_positions_8ce35d52:
    ...
    e "Quando o definimos para 1.0, estamos alinhados ao lado direito da tela."
...
translate spanish tutorial_positions_6745825f:
    ...
    e "E quando o definimos para 0,5, voltamos ao centro da tela."
...
translate spanish tutorial_positions_64428a07:
    ...
    e "Definir o alinhamento y é semelhante, exceto ao longo do eixo y."
...
translate spanish tutorial_positions_cfb77d42:
    ...
    e "Lembre-se de que xalign está apenas definindo xpos e xanchor com o mesmo valor, e yalign está apenas definindo ypos e yanchor com o mesmo valor."
...
translate spanish tutorial_positions_cfc1723e:
    ...
    e "As propriedades xcenter e ycenter posicionam o centro da imagem. Aqui, com xcenter definido como 0,75, o centro da imagem está a três quartos do lado direito da tela."
...
translate spanish tutorial_positions_7728dbf9:
    ...
    e "A diferença entre xalign e xcenter é mais óbvia quando xcenter é 1.0, e a imagem está na metade do lado direito da tela."
...
translate spanish tutorial_positions_1b1cedc6:
    ...
    e "Existem as propriedades xoffset e yoffset, que são aplicadas depois de todo o resto e deslocam as coisas para a direita ou inferior, respectivamente."
...
translate spanish tutorial_positions_e6da2798:
    ...
    e "Claro, você pode usar números negativos para compensar as coisas à esquerda e ao topo."
...
translate spanish tutorial_positions_e0fe2d81:
    ...
    e "Por último, mencionarei que existem propriedades combinadas como alinhar, pos, âncora e centro. Alinhar pega um par de números e define xalinhamento para o primeiro e yalinhamento para o segundo. Os outros são semelhantes."
...
translate spanish tutorial_positions_0f4ca2b6:
    ...
    e "Depois de entender as posições, você pode usar transformações para mover as coisas pela tela do Ren'Py."
...
translate spanish tutorial_atl_d5d6b62a:
    ...
    e "Ren'Py usa transformações para animar, manipular e posicionar imagens. Já vimos a mais simples das transformações em uso:"
...
translate spanish tutorial_atl_7e853c9d:
    ...
    e "As transformações podem ser coisas muito simples que colocam a imagem em algum lugar da tela, como a transformação certa."
...
translate spanish tutorial_atl_87a6ecbd:
    ...
    e "Mas transformações também podem ser assuntos muito mais complicados, que introduzem animação e efeitos na mistura. Para demonstrar, vamos fazer um Concerto de Rock Gratuito!"

# game/tutorial_atl.rpy:437
translate spanish tutorial_atl_65badef3:

    # e "But first, let's have... a Gratuitous Rock Concert!"
    e "Mas primeiro, vamos ter ... um Concerto de Rock Gratuito!"
...
translate spanish tutorial_atl_e0d3c5ec:
    ...
    e "Foi muito trabalhoso, mas foi construído com pequenas partes."
...
translate spanish tutorial_atl_f2407514:
    ...
    e "A maioria das transformações no Ren'Py são construídas usando Animation and Transform Language, ou ATL para breve."
...
translate spanish tutorial_atl_1f22f875:
    ...
    e "Existem atualmente três lugares onde ATL pode ser usado em Ren'Py."
...
translate spanish tutorial_atl_fd036bdf:
    ...
    e "O primeiro lugar onde o ATL pode ser usado é como parte de uma declaração de imagem. Em vez de um displayable, uma imagem pode ser definida como um bloco de código ATL."
...
translate spanish tutorial_atl_7cad2ab9:
    ...
    e "Quando usado dessa forma, temos que ter certeza de que o ATL inclui um ou mais exibíveis para realmente mostrar."
...
translate spanish tutorial_atl_c78b2a1e:
    ...
    e "A segunda maneira é por meio do uso da instrução transform. Isso atribui o bloco ATL a uma variável python, permitindo que seja usado em cláusulas at e dentro de outras transformações."
...
translate spanish tutorial_atl_da7a7759:
    ...
    e "Finalmente, um bloco ATL pode ser usado como parte de uma instrução show, em vez da cláusula at."
...
translate spanish tutorial_atl_1dd345c6:
    ...
    e "Quando o ATL é usado como parte de uma instrução show, os valores das propriedades existem mesmo quando a transformação é alterada. Portanto, mesmo que um clique seu clique tenha interrompido o movimento, a imagem permanece no mesmo lugar."
...
translate spanish tutorial_atl_98047789:
    ...
    e "A chave para ATL é o que chamamos de composição. ATL é composta de comandos relativamente simples, que podem ser combinados para criar transformações complicadas."
...
translate spanish tutorial_atl_ed82983f:
    ...
    e "Antes de explicar como o ATL funciona, deixe-me explicar o que são animação e transformação."
...
translate spanish tutorial_atl_2807adff:
    ...
    e "Animação é quando o que está sendo mostrado muda. Por exemplo, agora estou mudando minha expressão."
...
translate spanish tutorial_atl_3eec202b:
    ...
    e "A transformação envolve mover ou distorcer uma imagem. Isso inclui colocá-la na tela, aumentar e diminuir o zoom, girá-la e alterar sua opacidade."
...
translate spanish tutorial_atl_fbc9bf83:
    ...
    e "Para apresentar a ATL, vamos começar examinando uma animação simples. Aqui está uma que consiste em cinco linhas de código ATL, contidas em uma instrução de imagem."
...
translate spanish tutorial_atl_bf92d973:
    ...
    e "Para alterar um exibível, basta mencioná-lo em uma linha de ATL. Aqui, estamos alternando entre duas imagens."
...
translate spanish tutorial_atl_51a41db4:
    ...
    e "Como estamos definindo uma imagem, a primeira linha do ATL deve fornecer uma exibição. Caso contrário, não haveria nada para mostrar."
...
translate spanish tutorial_atl_3d065074:
    ...
    e "A segunda e a quarta linhas são declarações de pausa, que fazem o ATL esperar meio segundo cada antes de continuar. É assim que damos o atraso entre as imagens."
...
translate spanish tutorial_atl_60f2a5e8:
    ...
    e "A linha final é uma instrução de repetição. Isso faz com que o bloco atual do ATL seja reiniciado. Você só pode ter uma instrução de repetição por bloco."
...
translate spanish tutorial_atl_146cf4c4:
    ...
    e "Se escrevermos a repetição 2 em vez disso, a animação será repetida duas vezes e, em seguida, será interrompida."
...
translate spanish tutorial_atl_d90b1838:
    ...
    e "Omitir a instrução repeat significa que a animação é interrompida assim que chegarmos ao final do bloco de código ATL."
...
translate spanish tutorial_atl_e5872360:
    ...
    e "Por padrão, os exibíveis são substituídos instantaneamente. Também podemos usar uma cláusula with para fornecer uma transição entre os exibíveis."
...
translate spanish tutorial_atl_2e9d63ea:
    ...
    e "Com a animação feita, veremos como podemos usar ATL para transformar imagens, começando com o posicionamento de uma imagem na tela."
...
translate spanish tutorial_atl_ddc55039:
    ...
    e "A coisa mais simples que podemos fazer é posicionar estaticamente uma imagem. Isso é feito fornecendo os nomes das propriedades da posição, seguidos dos valores das propriedades."
...
translate spanish tutorial_atl_43516492:
    ...
    e "Com mais algumas declarações, podemos mover as coisas na tela."
...
translate spanish tutorial_atl_fb979287:
    ...
    e "Este exemplo inicia a imagem no canto superior direito da tela e espera um segundo. Em seguida, move-a para o lado esquerdo, espera outro segundo e repete."
...
translate spanish tutorial_atl_7650ec09:
    ...
    e "As instruções pause e repeat são as mesmas que usamos em nossas animações. Elas funcionam em todo o código ATL."
...
translate spanish tutorial_atl_d3416d4f:
    ...
    e "Ter a imagem pulando na tela não é tão útil. É por isso que o ATL tem a instrução de interpolação."
...
translate spanish tutorial_atl_4e7512ec:
    ...
    new # e "A instrução de interpolação permite que você varie suavemente o valor de uma propriedade de transformação, de um valor antigo para um novo."
...
translate spanish tutorial_atl_685eeeaa:
    ...
    e "Aqui, temos uma instrução de interpolação na segunda linha ATL. Ela começa com o nome de uma função de tempo, neste caso linear."
...
translate spanish tutorial_atl_c5cb49de:
    ...
    e "Isso é seguido por um período de tempo, neste caso três segundos. Termina com uma lista de propriedades, cada uma seguida por seu novo valor."
...
translate spanish tutorial_atl_04b8bc1d:
    ...
    e "O valor de cada propriedade é interpolado de seu valor no início da instrução para o valor no final da instrução. Isso é feito uma vez por quadro, permitindo uma animação suave."
...
translate spanish tutorial_atl_2958f397:
    ...
    e "O ATL suporta tipos de movimento mais complicados, como movimento circular e spline. Mas não os mostrarei aqui."
...
translate spanish tutorial_atl_d08fe8d9:
    ...
    e "Além de exibíveis, pausa, interpolação e repetição, existem algumas outras declarações que podemos usar como parte do ATL."
...
translate spanish tutorial_atl_84b22ac0:
    ...
    e "As transformações ATL criadas usando a instrução tornam-se as próprias instruções ATL. Como as posições padrão também são transformadas, isso significa que podemos usar a esquerda, a direita e o centro dentro de um bloco ATL."
...
translate spanish tutorial_atl_331126c1:
    ...
    e "Aqui, temos duas novas instruções. A instrução de bloco permite incluir um bloco de código ATL. Como a instrução de repetição se aplica a blocos, isso permite que você repita apenas parte de uma transformação ATL."
...
translate spanish tutorial_atl_24f67b67:
    ...
    e "Também temos a declaração de tempo, que é executada após um determinado número de segundos decorridos desde o início do bloco. Ela será executada mesmo se outra declaração estiver em execução, interrompendo a outra declaração."
...
translate spanish tutorial_atl_b7709507:
    ...
    e "Portanto, este exemplo salta a imagem para frente e para trás por onze segundos e meio e depois a move para o lado direito da tela."
...
translate spanish tutorial_atl_f903bc3b:
    ...
    e "A instrução paralela nos permite executar dois blocos de código ATLANTA ao mesmo tempo."
...
translate spanish tutorial_atl_5d0f8f9d:
    ...
    e "Aqui, o bloco superior move a imagem na direção horizontal, e o bloco inferior move na direção vertical. Como eles estão se movendo em velocidades diferentes, parece que a imagem está saltando na tela."
...
translate spanish tutorial_atl_28a7d27e:
    ...
    e "Finalmente, a declaração de escolha faz Ren'Py escolher aleatoriamente um bloco de código ATL. Isso permite que você adicione algumas variações ao que Ren'Py mostra."
...
translate spanish tutorial_atl_2265254b:
    ...
    e "Este tutorial de jogo apenas arranhou a superfície do que você pode fazer com ATL. Por exemplo, ainda não cobrimos as declarações on e event. Para obter mais informações, você pode verificar {a = https: // renpy .org / doc / html / atl.html} o capítulo ATL no manual de referência {/ a}. "
...
translate spanish transform_properties_391169cf:
    ...
    e "Ren'Py tem algumas propriedades de transformação que podem ser usadas com ATL, a instrução Transform exibível e a instrução add Screen Language."
...
translate spanish transform_properties_fc895a1f:
    ...
    e "Aqui, vamos exibi-los para que você possa vê-los em ação e se acostumar com o que cada um faz."
...
translate spanish transform_properties_88daf990:
    ...
    e "Em primeiro lugar, todas as propriedades de posição também são propriedades de transformação. Elas incluem as propriedades pos, âncora, alinhamento, centro e deslocamento."
...
translate spanish transform_properties_d7a487f1:
    ...
    e "As propriedades de posição também podem ser usadas para deslocar sobre um objeto exibível maior do que a tela, fornecendo valores negativos xpos e ypos."
...
translate spanish transform_properties_35934e77:
    ...
    e "As transformações também suportam coordenadas polares. A propriedade around define o centro do sistema de coordenadas para as coordenadas fornecidas em pixels."
...
translate spanish transform_properties_605ebd0c:
    ...
    e "A propriedade ângulo fornece o ângulo em graus. Os ângulos funcionam no sentido horário, com o ângulo zero na parte superior da tela."
...
translate spanish transform_properties_6d4555ed:
    ...
    e "A propriedade radius fornece a distância em pixels da âncora do exibível ao centro do sistema de coordenadas."
...
translate spanish transform_properties_7af037a5:
    ...
    e "Existem várias maneiras de redimensionar um exibível. A propriedade zoom nos permite dimensionar um exibível por um fator, tornando-o maior e menor."
...
translate spanish transform_properties_b6527546:
    ...
    e "As propriedades xzoom e yzoom permitem que o exibível seja dimensionado nas direções X e Y independentemente."
...
translate spanish transform_properties_b98b780b:
    ...
    e "Ao tornar xzoom ou yzoom um número negativo, podemos virar a imagem horizontalmente ou verticalmente."
...
translate spanish transform_properties_74d542ff:
    ...
    e "Em vez de aumentar o zoom por um fator de escala, a propriedade de transformação de tamanho pode ser usada para dimensionar um exibível para um tamanho em pixels."
...
translate spanish transform_properties_438ed776:
    ...
    e "A propriedade alpha é usada para alterar a opacidade de um exibível. Isso pode fazer com que ele apareça e desapareça."

# game/tutorial_atl.rpy:847
translate spanish transform_properties_aee19f86:

    # e "The rotate property rotates a displayable."
    e "A propriedade rotate gira em um exibível."
...
translate spanish transform_properties_57b3235a:
    ...
    e "Por padrão, quando um exibível é girado, Ren'Py incluirá espaço extra em todos os quatro lados, para que o tamanho não mude conforme ele gira. Aqui, você pode ver o espaço extra à esquerda e superior, e também lá no lado direito e inferior. "
...
translate spanish transform_properties_66d29ee8:
    ...
    e "Definindo rotate_pad como False, podemos nos livrar do espaço, ao custo da mudança do tamanho do exibível conforme ele gira."
...
translate spanish transform_properties_7f32e8ad:
    ...
    e "As propriedades de transformação do bloco, xtile e ytile, repetem o exibível várias vezes."
...
translate spanish transform_properties_207b7fc8:
    ...
    e "A propriedade crop corta um retângulo de um exibível, mostrando apenas parte dele."
...
translate spanish transform_properties_e7e22d28:
    ...
    e "Quando usados ​​juntos, o corte e o tamanho podem ser usados ​​para focar em partes específicas de uma imagem."
...
translate spanish transform_properties_f34abd82:
    ...
    e "As propriedades xpan e ypan podem ser usadas para deslocar sobre um exibível, dado um ângulo em graus, com 0 sendo o centro."
...
translate spanish transform_properties_bfa3b139:
    ...
    e "Essas são todas as propriedades de transformação com as quais temos que trabalhar. Ao colocá-las juntas na ordem certa, você pode criar coisas complexas."
